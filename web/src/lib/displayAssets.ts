...
const DISPLAY: Record<string, AssetDisplay> = {
  ...
  sUSDe: { name: "Safe Dollars", ticker: "sUSDe", logo: "https://assets.coingecko.com/coins/images/33613/small/USDE.png", color: "#c19a52", glyph: "$", kind: "safe", cat: "Safer", desc: "A dollar-based savings asset that aims to hold its value while paying a steady yield. It's the calmest option here, though the rate moves over time and isn't guaranteed.", price: 1.0, apy: "4.8%", day: 0, spark: [8, 8, 8, 8, 8, 8, 8, 8, 8, 8] },
  ...
  mETH: { name: "Staked ETH", ticker: "mETH", logo: `${CRYPTO_ICON}/eth.svg`, color: "#5b7fd0", kind: "crypto", cat: "Crypto", desc: "Ethereum that's staked to help secure the network, earning a steady staking reward on top of Ether's own price moves. Crypto, so expect bigger swings.", price: 3180.0, apy: "3.6%", day: 0.9, spark: [5, 6, 6, 7, 6, 7, 8, 8, 9, 9] },
